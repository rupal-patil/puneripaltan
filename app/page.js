...
export default function Home() {
  return (
    <section>
      <div>
        <img alt="image here" src="/home-background.webp" width={"100%"} className={`${classes.deskblock}`} />
        <img alt="image here" src="/mobile-home-backgroung.webp" width={"100%"} className={`${classes.desknone}`} />
      </div>
      <section className={`${classes.description}`} style={{ backgroundImage: "url('./description-bg.jpg')" }}>
        ...
        <div className={`container mx-auto ${classes.box2}`}>
          <p className={`${classes.para} ${exo.className}`}>
            Puneri Paltan is currently one of the top performing teams in the Pro Kabaddi League. With a mix of unstoppable energy, honed-out skills and steely nerves, here&rsquo;s a force that consistently looks forward to perform better, challenge its opponents and make a difference.
          </p>
        </div>
        <div>
        ...
        <div className="container mx-auto p-8">
         ...
         <div className="absolute bottom-[-40%] sm:bottom-[-40%] lg:bottom-[-70%] left-5 md:left-0 w-[88%] sm:w-[88%] md:w-[95%] lg:w-[95%]  md:h-[79%] lg:h-[400px] flex flex-col md:flex-row lg:flex-row  skew-x-[-15deg] px-0 sm:px-[15px]">
            <div className={`w-[100%] bg-[#2b2521] ${classes.box}`}><img  alt="image here" src="/buy-tickets-homepage_s11.png" className="w-[100%] h-[100%] mb-[-2%] skew-x-[15deg] "/></div>
        ...
        <div className="bg-[url('/puneri-world-bg-mob.jpg')] sm:bg-[url('/puneri-world-bg-mob.jpg')] md:bg-[url('/puneri-world-bg.jpg')] lg:bg-[url('/puneri-world-bg.jpg')] bg-cover bg-center overflow-hidden md:overflow-hidden">
          <div className="">
            <div className="relative ">
              <img alt="image here" src="/paltan-world-1.png" className={`relative z-[999] hidden sm:hidden md:block lg:block ${classes.slowdown}`}/>
              <img alt="image here" src="/paltan-world-mob-1.png" className="relative block md:hidden lg:hidden z-[999]"/>
              <img  alt="image here" src="/paltan-world-3.png" className={`absolute left-[40%] md:left-[58%] lg:left-[66%] top-[15%] md:top-[1%] lg:top-[20%] w-[160px] md:w-[360px] lg:w-[330px] z-[99] md:overflow-hidden  ${classes.zoom}`}/>
              <img alt="image here" src="/paltan-world-4.png" className={`absolute left-[33%] top-[-55px] z-[1] rotate-[11deg] hidden md:hidden lg:block ${classes.zoom}`}/>
              <img alt="image here" src="/paltan-world-5.png" className={`absolute top-[-40px] md:top-0 lg:top-0 z-[1] w-[400px] md:w-[500px] ${classes.zoom}`}/>
        ...
        <div className="container mx-auto">
            ...
            <div>
              <a href="https://forcemotors.com/" className="cursor-pointer">
                <div className="flex flex-col justify-center items-center pt-[30px]">
                  <img src="/force_motors.png" alt="image here" />
          ...
          <div className="flex justify-center items-center gap-8">
            <div><a href="https://batery.ai/" target="_blank" className="cursor-pointer">
              <div className="flex flex-col justify-center items-center pt-[30px]">
                <img alt="image here" src="/Batery-Ai_logo.png" />
            ...
            <div><a href="https://www.kirloskarpumps.com/" target="_blank" className="cursor-pointer">
              <div className="flex flex-col justify-center items-center pt-[30px]">
                <img alt="image here" src="/korloskar-brother-logo.png" />
          ...
          <div className="flex justify-center items-center">
            <div><a href="https://www.stihl.com/en" target="_blank" className="cursor-pointer">
              <div className="flex flex-col justify-center items-center pt-[30px]">
                <img alt="image here" src="/stihl-logo.png" />
          ...
          <div className="flex justify-center items-center">
            <div><a href="https://www.radiocity.in/" target="_blank" className="cursor-pointer">
              <div className="flex flex-col justify-center items-center pt-[30px]">
                <img src="/radio.png" alt="image here" />
            ...
            <div><a href="about:blank" target="_blank" className="cursor-pointer">
              <div className="flex flex-col justify-center items-center pt-[30px]">
                <img src="/icon-logo.png" alt="image here" />
            ...
            <div><a href="https://shivnaresh.in/" target="_blank" className="cursor-pointer">
              <div className="flex flex-col justify-center items-center pt-[30px]">
                <img src="/shiv-naresh-logo.png" alt="image here" />
